 ...
 *
 */
public class CartPoleLearnFromDemoSandbox extends TamerApplet {
	...
	public void initPanel() {
		...
		agent.envName = "CartPole"; //"Mountain-Car"; //"Loop-Maze";	
...
//		agent.params.numBiasingSamples = 50000;
//		agent.params.biasSampleWt = 0.1;
//		agent.params.wekaModelName = "IBk"; //"M5P"; // IBk is k-nearest neighbors, and M5P is a regression-tree algorithm
		
		/*
		 * Other options
		 */
		agent.params.modelClass = "IncGDLinearModel";
		agent.params.featClass = "FeatGen_RBFs"; // "FeatGen_Discretize";
		if (agent.params.featClass.equals("FeatGen_Discretize")){
			agent.params.featGenParams.put("numBinsPerDim", "10");
		}
		else if (agent.params.featClass.equals("FeatGen_RBFs")){
			agent.params.stepSize = 0.05; //0.19;
			agent.params.traceDecayFactor = 0.86;

			agent.params.featGenParams.put("basisFcnsPerDim", "8");
			agent.params.featGenParams.put("relWidth", "0.13"); 
		}
		...
		EnvironmentInterface env = new CartPole();
