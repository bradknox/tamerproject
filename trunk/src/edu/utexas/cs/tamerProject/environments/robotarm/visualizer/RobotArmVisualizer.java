...
import edu.utexas.cs.tamerProject.environments.robotarm.messages.StateRequest;
...
public class RobotArmVisualizer extends AbstractVisualizer implements ValueFunctionDataProvider, AgentOnValueFunctionDataProvider, GlueStateProvider {
    ...
    public RobotArmVisualizer(TinyGlue glueState, DynamicControlTarget theControlTarget) {
        super();
    ...
    protected void setupVizComponents() {
        ...
        SelfUpdatingVizComponent robotArmComponent = new RobotArmComponent(this);
        ...
        super.addVizComponentAtPositionWithSize(robotArmComponent, 0, 0, 1.0, 1.0);
    ...
    public int[] getLastAgentCoord() {
		...
		int[] agentCoord = new int[RobotArmState.worldDims.length];
