...
/**
 * Gathers statistics from logs per time-step interval in Tetris. 
 * @author bradknox
 */
public class TetrisPerStepIntervCtr {
	...
	public static double[] getSumOfRewPerInterv(int numberOfIntervals, String[] logPaths, 
		...
		for (int i = 0; i < logPaths.length; i++) {
			...
			double[] rewPerIntervCt = TetrisPerStepIntervCtr.getPerIntervCt(logPaths[i], intervalLen,
					metric, metStr);
	...
	public static void main(String[] args) {
		...
		double[] meanRewPerInterv = TetrisPerStepIntervCtr.getSumOfRewPerInterv(numberOfIntervals, logPaths, 
		...
		double[] meanPressesPerInterv = TetrisPerStepIntervCtr.getSumOfRewPerInterv(numberOfIntervals, logPaths, 
		...
		double[] meanMDPRewPerInterv = TetrisPerStepIntervCtr.getSumOfRewPerInterv(numberOfIntervals, logPaths, 
		...
		double[] meanPosHRewPerInterv = TetrisPerStepIntervCtr.getSumOfRewPerInterv(numberOfIntervals, logPaths, 
		...
		double[] meanNegHRewPerInterv = TetrisPerStepIntervCtr.getSumOfRewPerInterv(numberOfIntervals, logPaths, 
